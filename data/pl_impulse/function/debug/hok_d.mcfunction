...
data modify storage pm_motion: in set value {size:6,max_reflect:1,velocity:100,max_distance:100,max_time:100,c_drag:0,entity:false,events:{trail:"particle dust{color:[1,0.2,0.2],scale:1} ~ ~ ~ 0 0 0 0.001 1",last:"function pl_impulse:debug/hit"}}
execute as @e[tag=hok_temp] run function pm_motion:motion
